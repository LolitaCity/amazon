...
<div class="pageHeader">
    <form rel="pagerForm" onsubmit="return navTabSearch(this);" action="/System/log" method="post">
	<div class="searchBar">		
            <table class="searchContent">
                <tr>
                    <td>
                        内容关键字：<input type="text" name="content" value="<?php echo ($_POST['content']); ?>"/>
                    </td> 
                    <td>
                        操作人：<input type="text" name="user_id"  value="<?php echo ($_POST['user_id']); ?>"/>
                    </td>
                    <td>
    ...
    <table class="table" width="70%" layoutH="138">
        <thead>
            <tr>
                ...
                <th width="80" orderField='user_id' <?php if($_REQUEST['_order'] == 'user_id'): ?>class="<?php echo ($_REQUEST["_sort"]); ?>"<?php endif; ?> align="center">操作人</th>
                <th width="80" align="center">数据库</th>
                <th width="180" >内容</th>
